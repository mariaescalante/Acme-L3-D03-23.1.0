...
<acme:form>
	...
	<acme:input-email code="any.note.form.label.emailAddress" path="emailAddress"/>
	<acme:input-url code="any.note.form.label.link" path="link"/>
	
	<acme:submit test="${_command == 'create'}" code="any.note.form.button.create" action="/any/note/create"/>
