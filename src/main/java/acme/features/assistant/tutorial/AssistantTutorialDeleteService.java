...
public class AssistantTutorialDeleteService extends AbstractService<Assistant, Tutorial> {
	...
	public void authorise() {
		...
		status = tutorial.getAssistant().getId() == principal.getActiveRoleId();
	...
	public void bind(final Tutorial object) {
		...
		super.bind(object, "code", "title", "abstract$", "goal", "totalTime");
	...
	public void perform(final Tutorial object) {
		...
		final Collection<Session> session;

		session = this.repository.findManySessionByTutorial(object);
